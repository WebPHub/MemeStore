...
public class LikeController {
    ...
    public Object getUserLike(@RequestParam Long userId, @RequestParam Long imgId){
    ...
    @PostMapping("/like/up")
    public Object likeup(LikeForm form){
        try{
            LikeMeme like = new LikeMeme();
            like.setId(form.getId());
    ...
    public Object likedown(LikeForm form){
        LikeMeme like = new LikeMeme();
        like.setId(form.getId());
        like.setImgid(form.getImgid());
        like.setMemberid(form.getMemberid());
